...
public class ProductsSpecifications {
    ...
    public static Specification<Product> partName(String titlePart) {
    ...
    public static Specification<Product> categoryLike(String categoryPart) {
        return (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.like(root.get("category").get("name"), String.format("%%%s%%", categoryPart));
    }
}
